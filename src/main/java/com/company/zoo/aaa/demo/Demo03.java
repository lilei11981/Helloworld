...
public class Demo03 {
    ...
    // public static void main(String[] args) {
    // int c = '依';£££££££££££££££££ππππππœ∑￿®®†¥￿￿￿￿￿øπåß∂ƒ©˙˙∆˚¬…Ωçç√∫￿￿µ￿￿￿￿￿￿￿￿∆￿￿￿nnn￿￿￿uuuunnnµµµµ
    ...
    //         int job = random.nextInt(6) + 1;
    //         int num = convertByIf(job);
    //         // int num = convertBySwitch(job);
    //         int count = 1;
    ...
    //
    //
    // public static int convertByIf(int job) {
    //     if (1 == job) {
    //         return 10;
    //     }
    //     if (2 == job) {
    ...
    // }
    //
    // public static int convertBySwitch(int job) {
    //     switch (job) {
    //         case 1:
    //             return 10;
    //         case 2:
